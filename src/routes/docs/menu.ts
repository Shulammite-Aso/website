...
export const MENU: MenuEntry[] = [
  ...
  M("Editors", "editors", [
    M("CLion", "editors/clion", [], "soon" as MenuStatus),
    M("DataGrip", "editors/datagrip", [], "soon" as MenuStatus),
    M("GoLand", "editors/goland", [], "beta" as MenuStatus),
    M("IntelliJ IDEA", "editors/intellij", [], "beta" as MenuStatus),
    M("PhpStorm", "editors/phpstorm", [], "soon" as MenuStatus),
    M("PyCharm", "editors/pycharm", [], "soon" as MenuStatus),
    M("Rider", "editors/rider", [], "soon" as MenuStatus),
    M("RubyMine", "editors/rubymine", [], "soon" as MenuStatus),
    M("VS Code", "editors/vscode", [], "beta" as MenuStatus),
    M("VS Code Extensions", "editors/vscode-extensions"),
    M("WebStorm", "editors/webstorm", [], "soon" as MenuStatus),
  ]),
