...
export const MENU: MenuEntry[] = [
  ...
  M("IDE", "ide", [
    M("CLion", "ide/clion", [], "soon" as MenuStatus),
    M("DataGrip", "ide/datagrip", [], "soon" as MenuStatus),
    M("GoLand", "ide/goland", [], "beta" as MenuStatus),
    M("IntelliJ IDEA", "ide/intellij", [], "beta" as MenuStatus),
    M("PhpStorm", "ide/phpstorm", [], "soon" as MenuStatus),
    M("PyCharm", "ide/pycharm", [], "soon" as MenuStatus),
    M("Rider", "ide/rider", [], "soon" as MenuStatus),
    M("RubyMine", "ide/rubymine", [], "soon" as MenuStatus),
    M("VS Code", "ide/vscode", [], "beta" as MenuStatus),
    M("VS Code Extensions", "ide/vscode-extensions"),
    M("WebStorm", "ide/webstorm", [], "soon" as MenuStatus),
  ]),
